                ...
                if ($upload_akte != "" && $upload_kartu_keluarga != "" && $foto_anak != "" && $foto_keluarga != "") {
                        ...
                        if ($daftar['status_pendaftaran'] == 1) {
                            echo "<div class='alert alert-success alert-dismissable'>
                              ...
                              <strong>Selamat!</strong> Anda Diterima di SMP 2 TAMAN, Selanjutnya Cetak Bukti Kelulusan dan Serahkan ke panitia untuk daftar ulang <a href='include/cetak.php'><u>CETAK BUKTI</u></a>.
                            </div>"; 
                            ...
                            echo "<div class='alert alert-danger alert-dismissable'>
                              <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
                              <strong>Mohon Maaf Anda Tidak Diterima Disekolah SMP 2 TAMAN</strong> 
                            </div>";
