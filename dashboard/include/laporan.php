...
<div class="row">
    <div class="col-sm-12 col-md-8 col-lg-10 col-lg-offset-1">
        <div class="card" style="margin-top: 50px">
			...
			<div class="row">
				<center><a href="include/cetak_laporan_pendaftar.php" class="btn btn-primary"><i class="fa fa-print"></i> Cetak Laporan Pendaftar PDF</a></center>
			</div>
			<div class="row">
				<center><a href="include/cetak_laporan_pendaftar_excel.php" class="btn btn-primary"><i class="fa fa-print"></i> Cetak Laporan Pendaftar EXCEL</a></center>
			</div>
