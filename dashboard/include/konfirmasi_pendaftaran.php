...
if (isset($_SESSION['message'])) {
    echo "<div class='alert alert-success alert-dismissable'>
      ...
      <strong>Berhasil!</strong> Terima pendaftaran.
    </div>";
}else if (isset($_SESSION['message1'])) { 
	echo "<div class='alert alert-danger alert-dismissable'>
      <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
      <strong>Berhasil!</strong> Tolak pendaftaran.
    </div>";
}
?>
									...
									<tr>
										...
										<td>
											<?php 
												...
												// $status == 2;
												if ($status == 0) {
													echo "<p><font color=#e74c3c>Belum dikonfirmasi</font></p>";
													
												}else if ($status == 2) {
													echo "<p><font color=#e74c3c>Tertolak</font></p>";
												}
												else{
													echo "<p><font color=##2ecc71>Sudah dikonfirmasi</font></p>";
												}
												// $status == 0 ? 
										...
										<td>
											...
											<a href="include/detail_foto.php?u=<?php echo $rows['id_daftar'];?>" class="btn btn-facebook btn-sm">Detail</a>
											<a href="include/proses_konfirmasi_pendaftaran.php?ida=<?php echo $rows['id_akun'] ?>&idd=<?php echo $rows['id_daftar'] ?>&idu=<?php echo $Id ?>" class="btn btn-warning btn-sm">Terima</a>
											<a href="include/proses_konfirmasi_pendaftaran_tolak.php?ida=<?php echo $rows['id_akun'] ?>&idd=<?php echo $rows['id_daftar'] ?>&idu=<?php echo $Id ?>" class="btn btn-danger btn-sm">Tolak</a>
										</td>
									</tr>
